...
<head>
    ...
    <!-- Site Metas -->
    <title>Regulat Account List</title>
...
<body>
    ...
    <div class="text-center">
        <h1 style="font-size: 50px;">Regular Account List</h1>
          ...
          <tbody>
            @foreach ($regularlist as $regular)
                <tr>
                  ...
                  <td>{{$regular['account_name']}}</td>
                  <td>{{$regular['account_number']}}</td>
                  <td>{{$regular['account_balance']}}</td>
                  <td>{{$regular['account_category']}}</td>
                  ...
                  <td>
                    ...
                    <button type="button" class="btn btn-warning">
                        <a style="color: white;" href="regularedit/{{$regular['id']}}">Edit</a>
                    </button>
