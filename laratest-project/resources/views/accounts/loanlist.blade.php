...
<body>
    ...
    <div class="text-center">
        <h1 style="font-size: 50px;">Loan List</h1>
          ...
          <tbody>
            @foreach ($loanlist as $loan)
                <tr>
                  ...
                  <td>
                    <form action="{{ action('LoanController@approval', $loan['id'] )}}" accept-charset="UTF-8" method="post">
                        @csrf
                    <input type="checkbox" name="approved">
                    <button type="submit" name="submit">Set
